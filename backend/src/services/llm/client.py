...
class LLMClient:
    ...
    def get_model_func(self):
        ...
        # OpenAI-compatible bindings use lightrag (has caching) - REMOVED FOR STANDALONE
        ...
        def llm_model_func(
            ...
            **kwargs: Any,
            ...
            # Standalone fallback: NO CACHE SUPPORT
            raise NotImplementedError("LightRAG caching is disabled in standalone mode.")
            # lightrag_kwargs = {
